...
exports.blueBookEntries = (0, pg_core_1.pgTable)('blue_book_entries', {
    ...
    checkNumber: (0, pg_core_1.text)('check_number'),
    checkDate: (0, pg_core_1.date)('check_date'),
    checkTotal: (0, pg_core_1.decimal)('check_total'),
    isAch: (0, pg_core_1.boolean)('is_ach').default(false),
