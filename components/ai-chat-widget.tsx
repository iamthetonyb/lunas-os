        ...
        <div className="fixed bottom-6 right-6 z-50 w-[400px] h-[560px] bg-white dark:bg-slate-900 rounded-2xl shadow-2xl flex flex-col border border-gray-200 dark:border-slate-700 overflow-hidden">
            ...
            <div className="flex items-center justify-between px-4 py-3 bg-blue-600 text-white">
                <div className="flex items-center gap-2">
                    ...
                    <span className="font-semibold text-sm">LUNAS AI</span>
                    <span className="text-[10px] bg-blue-500 px-1.5 py-0.5 rounded-full">GPT-5.4n</span>
                </div>
                <div className="flex items-center gap-1">
                    <button
                        onClick={() => setVoiceMode(!voiceMode)}
                        className={`p-1.5 rounded-lg transition-colors ${voiceMode ? 'bg-blue-500 text-white' : 'text-blue-200 hover:text-white'}`}
                    ...
                    {voiceMode && (
                        <button
                            ...
                            className={`p-1.5 rounded-lg transition-colors ${ttsEnabled ? 'bg-blue-500 text-white' : 'text-blue-200 hover:text-white'}`}
            ...
            <div className="flex-1 overflow-y-auto px-4 py-3 space-y-3">
                {messages.length === 0 && (
                    <div className="text-center text-gray-400 dark:text-slate-500 mt-12 space-y-2">
                        <svg xmlns="http://www.w3.org/2000/svg" className="w-10 h-10 mx-auto text-blue-300" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
                            <path strokeLinecap="round" strokeLinejoin="round" d="M9.813 15.904L9 18.75l-.813-2.846a4.5 4.5 0 00-3.09-3.09L2.25 12l2.846-.813a4.5 4.5 0 003.09-3.09L9 5.25l.813 2.846a4.5 4.5 0 003.09 3.09L15.75 12l-2.846.813a4.5 4.5 0 00-3.09 3.09zM18.259 8.715L18 9.75l-.259-1.035a3.375 3.375 0 00-2.455-2.456L14.25 6l1.036-.259a3.375 3.375 0 002.455-2.456L18 2.25l.259 1.035a3.375 3.375 0 002.455 2.456L21.75 6l-1.036.259a3.375 3.375 0 00-2.455 2.456z" />
                        </svg>
                        <p className="text-sm font-medium">LUNAS AI</p>
                    ...
                    >
                        ...
                        >
                            {msg.parts?.map((part, i) => {
                                ...
                                // Tool parts have type `tool-{name}` in SDK 6
            ...
            <div className="border-t border-gray-200 dark:border-slate-700 p-3">
                {voiceMode ? (
                    <div className="flex flex-col items-center gap-2">
                        ...
                        {input && (
                            <p className="text-xs text-gray-700 dark:text-gray-300 bg-gray-100 dark:bg-slate-800 rounded px-2 py-1 max-w-full truncate">
                                {input}
                            </p>
                        )}
                    </div>
