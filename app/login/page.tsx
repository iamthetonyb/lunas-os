    ...
    <main className="min-h-screen flex items-center justify-center p-6 bg-gray-50">
      <div className="w-full max-w-md">
        <div className="bg-white rounded-lg shadow-md p-8">
          ...
          {/* Only show OAuth section when at least one provider is configured */}
          {(hasGoogle || hasMicrosoft) && (
            <div className="mt-6">
              ...
              <div className={`mt-6 grid gap-3 ${hasGoogle && hasMicrosoft ? 'grid-cols-2' : 'grid-cols-1'}`}>
                {hasGoogle && (
                  <button
                    type="button"
          ...
          {/* Show setup notice when no OAuth providers are configured */}
          {availableProviders && !hasGoogle && !hasMicrosoft && (
            <div className="mt-6 p-3 bg-gray-50 rounded-lg border border-gray-200">
              <p className="text-xs text-gray-500 text-center">
                Google and Microsoft sign-in will appear here once configured by your admin.
              </p>
            </div>
          )}
