    ...
    <>
      ...
      <main className="px-6 py-6">
        ...
        <div className="bg-white dark:bg-slate-800 rounded-lg shadow-sm border border-gray-200 dark:border-slate-700 p-6 mb-6">
          <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4 pb-2 border-b border-gray-200 dark:border-slate-700">
            {t('invoicing.buildNewInvoice')}
          </h3>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">{t('invoicing.selectBuilder')}</label>
              <select
                onChange={(e) => setBuilderId(e.target.value || null)}
                className="w-full px-4 py-2 border border-gray-300 dark:border-slate-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 bg-white dark:bg-slate-700 dark:text-white"
              >
        ...
        <div className="bg-white dark:bg-slate-800 rounded-lg shadow-sm border border-gray-200 dark:border-slate-700 overflow-hidden">
          <div className="px-6 py-4 border-b border-gray-200 dark:border-slate-700">
            <h3 className="text-lg font-semibold text-gray-900 dark:text-white">{t('invoicing.recentInvoices')}</h3>
          </div>
          <QueryWrapper
                          ...
                          <tr key={invoice.id} className="hover:bg-gray-50 dark:hover:bg-slate-800">
                            ...
                            <td className="px-6 py-4 whitespace-nowrap text-sm">
                              <div className="flex gap-3">
                                ...
                                <button className="text-gray-600 dark:text-gray-400 hover:text-gray-800 font-medium">
                                  {t('invoicing.pdf')}
                                </button>
                                {statusLabel === 'Draft' && (
